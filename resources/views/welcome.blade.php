...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="bg-main-gray">
        <header class="shadow">
            <nav x-data="{ isOpen: false }" class="container mx-auto lg:flex items-center justify-between py-3 px-6">            
                ...
                <ul :class="isOpen ? 'show' : 'hidden'" class="lg:flex gap-12 text-lg">
        ...
        <section>
            <div class="container flex flex-col-reverse lg:flex-row items-center gap-12 mx-auto mt-14 lg:mt-28 px-6">
                ...
                <div class="flex justify-center flex-1 mb-10 md:mb-16 lg:mb-0 z-10">
                    <img src="{{ asset('images/landing-page-image.png') }}" alt="landing-page-image" class="w-5/6 h-5/6 sm:h-3/4 sm:h-3/4 md:w-full md:h-full"/>                   
                </div>
            </div>
        </section>
    </body>
