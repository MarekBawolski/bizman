...
<body class="bg-white">
  <header class="fixed z-10 w-full shadow bg-main-gray">
    <nav x-data="{ isOpen: false }" @click.away="isOpen = false" class="container items-center justify-between px-6 py-3 mx-auto lg:flex">
      <a href="/" class="float-left">
        <x-landing-page-logo />
      </a>

      <div class="flex items-center justify-end lg:hidden">
        <button type="button" class="p-2 text-blue-600" aria-label="toggle menu" @click="isOpen = !isOpen">
      ...
      <ul :class="isOpen ? 'show' : 'hidden'" @click="isOpen = false" class="gap-12 text-lg lg:flex">
        <li class="pt-10 duration-500 hover:text-cyan-500 p-7 lg:p-0 lg:pt-0">
          <a href="#home">Home</a>
        </li>
        <li class="duration-500 hover:text-cyan-500 p-7 lg:p-0">
      ...
      <div :class="isOpen ? 'show' : 'hidden'" class="text-lg lg:flex">
        @if (Route::has('login'))
          @auth
            <a href="{{ url('/clients') }}">
              <button class="px-4 py-2 m-3 text-white duration-500 bg-blue-600 rounded hover:bg-blue-500">
                Dashboard
              </button>
            </a>
          @else
            <a href="{{ route('login') }}">
              <button class="px-4 py-2 m-3 duration-500 rounded bg-main-gray hover:bg-blue-500 hover:text-white">
                Logowanie
              </button>
            </a>
  ...
  <section id="home" class="bg-main-gray">
    <div class="container flex flex-col-reverse items-center gap-12 px-6 pt-40 mx-auto lg:flex-row">
      <div class="flex flex-col items-center flex-1 lg:items-start">
        <h2 class="mb-6 text-3xl font-extrabold text-center md:text-4xl lg:text-5xl lg:text-left">
          Erat dolores sea dolores lorem nonumy no invidunt rebum diam.
        </h2>
        <p class="mb-6 text-lg text-center lg:text-left">
          Kasd at kasd et ipsum stet aliquyam no est. Kasd amet tempor consetetur sit elitr et consetetur at. Aliquyam nonumy ut lorem sed eirmod eirmod, labore sit elitr dolore duo et magna dolores eirmod. Sit est lorem ea duo labore. Sanctus sit sed erat stet et diam
          diam, consetetur diam.
        </p>
        <div class="flex flex-wrap justify-center gap-6 mb-6">
          <button class="px-4 py-2 mx-4 text-lg text-white duration-500 bg-blue-600 rounded hover:bg-blue-500">
            Napisz do nas
          </button>
          <button class="px-4 py-2 mx-4 text-lg duration-500 bg-white border-2 border-gray-300 rounded hover:bg-blue-500 hover:text-white">
            Zamów demo
          </button>
        </div>
      </div>
  ...
  <section id="tools">
    <div class="container px-6 py-20 mx-auto text-center">
      <div class="flex flex-col justify-center pt-5 mb-6">
        <h2 class="mb-6 text-2xl font-extrabold text-center md:text-3xl lg:text-4xl">Et justo sea justo at stet sit ipsum, accusam lorem.</h2>
        <p class="mb-6 text-lg text-center">Sadipscing justo sanctus et tempor dolores no et est ipsum, dolores magna et stet ut sanctus. Sadipscing vero diam aliquyam stet sit, est voluptua dolore et ipsum stet eos. Labore consetetur sadipscing est stet sanctus at.
          Clita vero erat amet.</p>
      </div>
      <div class="items-center justify-around gap-10 lg:flex">
        <div class="flex flex-col justify-center gap-10">
          <div class="flex flex-col items-center">
            <button class="p-5 bg-blue-600 rounded">
            ...
            <h3 class="text-xl font-extrabold md:text-2xl lg:text-3xl">Dolore at at voluptua ipsum.</h3>
  ...
  <footer>
    <div class="container px-6 mx-auto mt-20 mb-10">
      <div class="flex flex-col items-center justify-between p-2 border-b-2 sm:flex-row">
        <svg width="193" height="55" viewBox="0 0 193 55" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
            d="M70.8713 26.4992C72.4128 26.8473 73.6311 27.6181 74.5262 28.8115C75.4461 29.9801 75.9061 31.3227 75.9061 32.8394C75.9061 35.0771 75.1353 36.8299 73.5938 38.098C72.0523 39.366 69.8892 40 67.1045 40H54.0885V13.707H66.6942C69.3794 13.707 71.4804 14.3038 72.9971 15.4972C74.5386 16.6906 75.3093 18.3689 75.3093 20.532C75.3093 22.0736 74.8991 23.3664 74.0786 24.4107C73.283 25.4301 72.2139 26.1263 70.8713 26.4992ZM61.3983 24.1496H65.0905C66.9304 24.1496 67.8504 23.3913 67.8504 21.8746C67.8504 20.3083 66.9304 19.5251 65.0905 19.5251H61.3983V24.1496ZM65.65 34.1074C67.4898 34.1074 68.4098 33.3366 68.4098 31.7951C68.4098 30.9995 68.1612 30.3903 67.6639 29.9677C67.1915 29.545 66.5077 29.3336 65.6127 29.3336H61.3983V34.1074H65.65Z"
            fill="#8896AB" />
          <path
            d="M82.056 17.1382C80.7631 17.1382 79.7188 16.7901 78.9232 16.0939C78.1524 15.3729 77.767 14.4778 77.767 13.4087C77.767 12.3147 78.1524 11.4072 78.9232 10.6862C79.7188 9.96512 80.7631 9.6046 82.056 9.6046C83.324 9.6046 84.3434 9.96512 85.1141 10.6862C85.9098 11.4072 86.3076 12.3147 86.3076 13.4087C86.3076 14.4778 85.9098 15.3729 85.1141 16.0939C84.3434 16.7901 83.324 17.1382 82.056 17.1382ZM85.6736 19.0775V40H78.3638V19.0775H85.6736Z"
            fill="#8896AB" />
          ...
          <path
            d="M134.584 18.891C137.22 18.891 139.283 19.6867 140.775 21.2779C142.292 22.8692 143.05 25.0447 143.05 27.8045V40H135.74V28.7742C135.74 27.6554 135.43 26.7852 134.808 26.1636C134.186 25.542 133.341 25.2312 132.272 25.2312C131.203 25.2312 130.357 25.542 129.736 26.1636C129.114 26.7852 128.803 27.6554 128.803 28.7742V40H121.494V28.7742C121.494 27.6554 121.183 26.7852 120.561 26.1636C119.965 25.542 119.132 25.2312 118.062 25.2312C116.969 25.2312 116.111 25.542 115.489 26.1636C114.868 26.7852 114.557 27.6554 114.557 28.7742V40H107.247V19.0775H114.557V21.8374C115.203 20.9423 116.036 20.2337 117.056 19.7115C118.1 19.1645 119.293 18.891 120.636 18.891C122.177 18.891 123.545 19.2267 124.738 19.898C125.957 20.5693 126.914 21.5141 127.61 22.7324C128.356 21.5887 129.338 20.6688 130.556 19.9726C131.775 19.2516 133.117 18.891 134.584 18.891Z"
            fill="#8896AB" />
          <path
            d="M145.116 29.5201C145.116 27.357 145.501 25.4674 146.272 23.8513C147.067 22.2352 148.137 20.992 149.479 20.1218C150.847 19.2516 152.363 18.8165 154.029 18.8165C155.471 18.8165 156.714 19.1024 157.759 19.6742C158.803 20.2461 159.611 21.0169 160.183 21.9865V19.0775H167.493V40H160.183V37.091C159.611 38.0607 158.79 38.8314 157.721 39.4033C156.677 39.9751 155.446 40.2611 154.029 40.2611C152.363 40.2611 150.847 39.826 149.479 38.9557C148.137 38.0855 147.067 36.8424 146.272 35.2262C145.501 33.5853 145.116 31.6832 145.116 29.5201ZM160.183 29.5201C160.183 28.1775 159.81 27.1208 159.064 26.35C158.343 25.5793 157.448 25.1939 156.379 25.1939C155.285 25.1939 154.377 25.5793 153.656 26.35C152.935 27.0959 152.575 28.1526 152.575 29.5201C152.575 30.8627 152.935 31.9319 153.656 32.7275C154.377 33.4982 155.285 33.8836 156.379 33.8836C157.448 33.8836 158.343 33.4982 159.064 32.7275C159.81 31.9567 160.183 30.8876 160.183 29.5201Z"
            fill="#8896AB" />
          <path
            d="M184.599 18.891C187.011 18.891 188.926 19.6991 190.343 21.3152C191.76 22.9065 192.469 25.0696 192.469 27.8045V40H185.159V28.7742C185.159 27.5808 184.848 26.6484 184.226 25.9771C183.605 25.2809 182.772 24.9328 181.728 24.9328C180.634 24.9328 179.776 25.2809 179.154 25.9771C178.533 26.6484 178.222 27.5808 178.222 28.7742V40H170.912V19.0775H178.222V22.0611C178.868 21.1163 179.739 20.358 180.833 19.7861C181.927 19.1894 183.182 18.891 184.599 18.891Z"
            fill="#8896AB" />
          <path fill-rule="evenodd" clip-rule="evenodd"
            d="M0 0V20.8414L11.8627 31.4183L27.3919 17.9757C28.8838 15.8047 30.2498 11.0147 23.7792 9.2223H9.4362V23.5507L4.36761 19.2261V4.22037H23.7792C29.1893 5.24507 38.2732 10.0768 31.3282 21.2061L11.8627 38.1918L0 27.7711V54.9691H24.588C33.8625 55.8027 51.6565 39.6507 35.4262 22.8734C41.3575 15.7873 37.637 -2.74846e-06 22.8086 0H0ZM13.8577 23.8633V13.4948L23.4557 13.3906C25.0518 14.1409 23.8691 15.4052 23.0783 15.9436L13.8577 23.8633ZM25.0194 50.6966C41.681 46.372 39.3085 31.6789 32.4605 26.0517L28.4704 29.4905C37.6556 36.8371 29.1713 46.2157 24.0488 45.7468H9.4362V41.6306L4.36761 37.4102V50.6966H25.0194ZM24.0488 41.4222C31.0586 38.6086 27.3919 33.0856 25.0194 32.3562L19.843 36.9934L14.6666 41.6306L24.0488 41.4222Z"
            fill="#8896AB" />
        </svg>
        <ul class="flex gap-10 mt-5 text-gray-400 sm:mt-0">
          <li class="flex gap-1">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512" class="w-5 h-5 fill-gray-400">
              <path
          ...
          <li class="flex gap-1 text-gray-400">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="w-5 h-5 fill-gray-400">
